...
class GVP_embedding(nn.Module):
    ...
    def __init__(self, node_in_dim, node_h_dim,
                 ...
                 seq_in=False, vector_gate=True, num_layers=3, drop_rate=0.1, voc_size=54, word_dim=54):                   

        super(GVP_embedding, self).__init__()
        self.vector_gate = vector_gate
        self.seq_in = seq_in
        if seq_in:
            self.W_s = nn.Embedding(voc_size, word_dim)
            node_in_dim = (node_in_dim[0] + word_dim, node_in_dim[1])
        ...
        self.W_out = nn.Sequential(
            ...
            GVP(node_h_dim, (ns, 0), vector_gate=vector_gate))
